...
<head>
  ...
  <link rel="stylesheet" href="<?= URL."/website/food/" ?>css/External/all.min.css">
  <!-- custom css file LInk -->
  <link rel="stylesheet" href="<?= URL."/website/food/" ?>css/style.css">
  <title>Food</title>
</head>
<body>
...
<div class="loader-container">
  ...
  <!-- custom js file LInk -->
  <script src="<?= URL."/website/food/" ?>js/min.js"></script>
</body>
</html>